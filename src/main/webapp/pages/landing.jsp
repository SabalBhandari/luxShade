...
<footer class="footer">
    ...
    <div class="footer-left">
        ...
        <div class="footer-socials">
            <a href="#"><img src="./images/socials/insta.png" alt="" srcset=""></a>
            <a href="#"><img src="./images/socials/fb.png" alt="" srcset=""></a>
        </div>
        <a href="#" class="back-to-top">
            <img src="./images/icons/uparrow.png" alt="" srcset=""> Back to top
        </a>
    </div>
    ...
    <div class="footer-middle">
        ...
        <ul class="contact-list">
            ...
            <li>
                <img src="./images/icons/mail.png" alt="" srcset="">
                <span>asdns@gmail.com</span>
            </li>
            <li>
                <img src="./images/icons/location.png" alt="" srcset="">
                <span>kathmandu, ktm</span>
            </li>
            <li>
                <img src="./images/icons/time.png" alt="" srcset="">
